...
fse %>%
  ...
  kbl(row.names = FALSE,  longtable = TRUE, caption = "Linear Effect Coverage")

```



```{r, fig.cap = "Parameter Bias and Variablilty"}
fse %>%
...
EpsLdf %>%
  ...
  kbl(row.names = FALSE,  longtable = TRUE, caption = "Observation Covariance Estimates")
...
EpsLdfcov %>%
  ...
  kbl(row.names = FALSE,  longtable = TRUE, caption = "Observation Covariance Coverage")
...
EtaLdf %>%
  select(param, true, LLT = ind, O = obs, S = st, OS = dub) %>%
  kbl(row.names = FALSE,  longtable = TRUE, caption = "State Covariance Estimates")
...
EtaLdfcov %>%
  select(param, LLT = ind, O = obs, S = st, OS = dub) %>%
  kbl(row.names = FALSE,  longtable = TRUE, caption = "State Covariance Coverage")
